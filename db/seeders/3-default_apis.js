  ...
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('Apis', [
      ...
      {name: "Infobip REST API",url: "https://www.infobip.com/docs/api",free: false,description: "The Infobip APIs allow for integration tools that aim to utilize Infobip products and services in a single place. Infobib has five different APIs; HTTP SMS API, Voice API, OMNI Channel API, Factor Authentication API, Number Lookup API and the Social Invites API. All APIs use REST standards, which enables browser based accessibility for URLs. The API intends to be able to work with all programming languages.", tags_id:1, createdAt: new Date(), updatedAt: new Date() },
      {
        ...
        url: "https://res.cloudinary.com/dt8q1ngxj/image/upload/v1631918832/Ace%20Api/espn_ltf7ry.jpg",
        tags_id: 9,
        createdAt: new Date(),
        updatedAt: new Date()
    },
    {
        ...
        url: "https://developer.yahoo.com/fantasysports/guide/?guccounter=1&guce_referrer=aHR0cHM6Ly93d3cuZ29vZ2xlLmNvbS8&guce_referrer_sig=AQAAAB4i270ENc0av7HeB33-e_JiLUM-eqmeCdtXNJGEYUImRnor75uXGKoptUjvvK6ixSVnT39um7qmeUiU4JjVtvayjAap7shL8ms-AV8BtSxFVsVO8dUGYulEqOL3eLgTA7eykYhMUtA3ngt5HG0Kiqklb6cj604R9ECDUIDYCo27",
        free: true,
        ...
        url: "https://res.cloudinary.com/dt8q1ngxj/image/upload/v1631918913/Ace%20Api/yahoo_zqqb4c.png",
        tags_id: 9,
        createdAt: new Date(),
        updatedAt: new Date()
    },
    {
        ...
        url: "https://res.cloudinary.com/dt8q1ngxj/image/upload/v1631918743/Ace%20Api/teamsnap_f9ivd0.png",
        tags_id: 9,
        createdAt: new Date(),
        updatedAt: new Date()
    },
    {
        ...
        url: "https://www.globaltennisnetwork.com/developers",
        free: true,
        ...
        url: "https://res.cloudinary.com/dt8q1ngxj/image/upload/v1631919166/Ace%20Api/globaltennis_eambqt.png",
        tags_id: 9,
        createdAt: new Date(),
        updatedAt: new Date()
    },
    {
        name: "iScore Sports",
        url: "http://api.iscorecentral.com/teamwebsiteapi.html",
        free: false,
        ...
        url: "https://res.cloudinary.com/dt8q1ngxj/image/upload/v1631919437/Ace%20Api/iscore_l8oswp.png",
        tags_id: 9,
        createdAt: new Date(),
        updatedAt: new Date()
    },
    {
        name: "Sportradar",
        url: "https://sportradar.us/sports-data/",
        free: false,
        ...
        url: "https://res.cloudinary.com/dt8q1ngxj/image/upload/v1631921088/Ace%20Api/sportradar_mbtu5x.jpg",
        tags_id: 9,
        createdAt: new Date(),
        updatedAt: new Date()
    },
    {
        name: "NFL",
        url: "https://developer.nfl.com/get-started/overview",
        free: false,
        ...
        url: "https://res.cloudinary.com/dt8q1ngxj/image/upload/v1631921582/Ace%20Api/nfl_x0wfpc.png",
        tags_id: 9,
        createdAt: new Date(),
        updatedAt: new Date()
    },
    {
        ...
        url: "https://res.cloudinary.com/dt8q1ngxj/image/upload/v1631922000/Ace%20Api/soccers_ywjjmm.jpg",
        tags_id: 9,
        createdAt: new Date(),
        updatedAt: new Date()
    },
    {
        ...
        url: "https://res.cloudinary.com/dt8q1ngxj/image/upload/v1631922227/Ace%20Api/golfworld_choxff.jpg",
        tags_id: 9,
        createdAt: new Date(),
        updatedAt: new Date()
    },
    {
        ...
        url: "https://res.cloudinary.com/dt8q1ngxj/image/upload/v1631922806/Ace%20Api/fitbit_orsp5d.jpg",
        tags_id: 9,
        createdAt: new Date(),
        updatedAt: new Date()
    },
    {
        ...
        url: "https://res.cloudinary.com/dt8q1ngxj/image/upload/v1631923239/Ace%20Api/importio_vwwnqr.png",
        tags_id: 4,
        createdAt: new Date(),
        updatedAt: new Date()
    },
    {
        name: "Diggernaut",
        url: "https://www.diggernaut.com/dev/api.html",
        free: false,
        ...
        url: "https://res.cloudinary.com/dt8q1ngxj/image/upload/v1631923385/Ace%20Api/diggernaut_xxpnuv.png",
        tags_id: 4,
        createdAt: new Date(),
        updatedAt: new Date()
    },
    {
        ...
        url: "https://res.cloudinary.com/dt8q1ngxj/image/upload/v1631923569/Ace%20Api/webscrape_ayhpe3.png",
        tags_id: 4,
        createdAt: new Date(),
        updatedAt: new Date()
    },
    {
        ...
        url: "https://res.cloudinary.com/dt8q1ngxj/image/upload/v1631923716/Ace%20Api/scrapeup_btx2yv.png",
        tags_id: 4,
        createdAt: new Date(),
        updatedAt: new Date()
    },
    {
        name: "SERPMaster",
        url: "https://serpmaster.com/",
        free: false,
        description: "ScrapeUp API is a real time proxy API for web scraping. This API enables users to get the HTML from any web page with an API call and handles proxies, browsers, and CAPTCHAs.",
        url: "https://res.cloudinary.com/dt8q1ngxj/image/upload/v1631923868/Ace%20Api/serp_e9fc4o.jpg",
        tags_id: 4,
        createdAt: new Date(),
        updatedAt: new Date()
    },
    {
        ...
        url: "https://res.cloudinary.com/dt8q1ngxj/image/upload/v1631924049/Ace%20Api/datashake_pcsewu.jpg",
        tags_id: 4,
        createdAt: new Date(),
        updatedAt: new Date()
    },
    {
        ...
        url: "https://res.cloudinary.com/dt8q1ngxj/image/upload/v1631924390/Ace%20Api/brandvantage_keljrw.png",
        tags_id: 4,
        createdAt: new Date(),
        updatedAt: new Date()
    },
    {
        ...
        url: "https://res.cloudinary.com/dt8q1ngxj/image/upload/v1632062327/Ace%20Api/locationscloud_iswopg.png",
        tags_id: 4,
        createdAt: new Date(),
        updatedAt: new Date()
    },
    {
        ...
        url: "https://res.cloudinary.com/dt8q1ngxj/image/upload/v1632062496/Ace%20Api/scrapingdog_ncbdgj.png",
        tags_id: 4,
        createdAt: new Date(),
        updatedAt: new Date()
    },
    {
        ...
        url: "https://res.cloudinary.com/dt8q1ngxj/image/upload/v1632062668/Ace%20Api/proxybot_kkk0rp.png",
        tags_id: 4,
        createdAt: new Date(),
        updatedAt: new Date()
    },
    {
        ...
        url: "https://res.cloudinary.com/dt8q1ngxj/image/upload/v1632063197/Ace%20Api/spotify_frrzuw.png",
        tags_id: 11,
        createdAt: new Date(),
        updatedAt: new Date()
    },
    {
        ...
        url: "https://res.cloudinary.com/dt8q1ngxj/image/upload/v1632064507/Ace%20Api/soundcloud_bal5dt.jpg",
        tags_id: 11,
        createdAt: new Date(),
        updatedAt: new Date()
    },
    {
        name: "Napster",
        url: "https://developer.napster.com/",
        free: true,
        ...
        url: "https://res.cloudinary.com/dt8q1ngxj/image/upload/v1632064613/Ace%20Api/napster_sknxka.png",
        tags_id: 11,
        createdAt: new Date(),
        updatedAt: new Date()
    },
    {
        ...
        url: "https://res.cloudinary.com/dt8q1ngxj/image/upload/v1632065297/Ace%20Api/pandora_treqca.png",
        tags_id: 11,
        createdAt: new Date(),
        updatedAt: new Date()
    },
    {
        ...
        url: "https://res.cloudinary.com/dt8q1ngxj/image/upload/v1632065417/Ace%20Api/lastfm_xczkox.png",
        tags_id: 11,
        createdAt: new Date(),
        updatedAt: new Date()
    },
    {
        ...
        url: "https://res.cloudinary.com/dt8q1ngxj/image/upload/v1632065511/Ace%20Api/musicbrainz_wvzkpi.png",
        tags_id: 11,
        createdAt: new Date(),
        updatedAt: new Date()
    },
    {
        ...
        url: "https://res.cloudinary.com/dt8q1ngxj/image/upload/v1632065671/Ace%20Api/discogs_fsu853.png",
        tags_id: 11,
        createdAt: new Date(),
        updatedAt: new Date()
    },
    {
        ...
        url: "https://res.cloudinary.com/dt8q1ngxj/image/upload/v1632065900/Ace%20Api/bandsintown_hb8emn.png",
        tags_id: 11,
        createdAt: new Date(),
        updatedAt: new Date()
    },
    {
        ...
        url: "https://res.cloudinary.com/dt8q1ngxj/image/upload/v1632066203/Ace%20Api/songkick_n2bftx.png",
        tags_id: 11,
        createdAt: new Date(),
        updatedAt: new Date()
    },
    {
        ...
        url: "https://res.cloudinary.com/dt8q1ngxj/image/upload/v1632066531/Ace%20Api/musixmatch_pxc88a.png",
        tags_id: 11,
        createdAt: new Date(),
        updatedAt: new Date()
    },
