		...
		return queryInterface.bulkInsert(
			...
			[
				...
				},
				{
					...
					logo_url:
						'https://res.cloudinary.com/dus2pwnkb/image/upload/v1632438594/Pixlab_kfvuei.png',
					tags_id: 1,
					createdAt: new Date(),
					updatedAt: new Date(),
				},
				...
				},
				{
					...
					logo_url:
						'https://res.cloudinary.com/dus2pwnkb/image/upload/v1632438723/Api2Cart_xttx8h.png',
					tags_id: '2',
					createdAt: new Date(),
					updatedAt: new Date(),
				},
				...
				},
				{
					...
					logo_url:
						'https://res.cloudinary.com/dus2pwnkb/image/upload/v1632351921/IDAnalyzer_omgeph.png',
					tags_id: '6',
					createdAt: new Date(),
					updatedAt: new Date(),
				},
				{
					...
					logo_url:
						'https://res.cloudinary.com/dus2pwnkb/image/upload/v1632351921/superTokens_okpemg.png',
					tags_id: '6',
					createdAt: new Date(),
					updatedAt: new Date(),
				},
				{
					...
					logo_url:
						'https://res.cloudinary.com/dus2pwnkb/image/upload/v1632351921/typingDNA_ofgxcg.png',
					tags_id: '6',
					createdAt: new Date(),
					updatedAt: new Date(),
				},
				{
					name: 'ThumbSignIn',
					website:
						'https://www.programmableweb.com/sites/default/files/styles/article_profile_150x150/public/icon_gravityforms.png?itok=a7Baeze_',
					free: false,
					description:
					...
					logo_url:
						'https://res.cloudinary.com/dus2pwnkb/image/upload/v1632351921/thumbSignin_prklbl.png',
					tags_id: '6',
					createdAt: new Date(),
					updatedAt: new Date(),
				},
				...
				},
				{
					...
					logo_url:
						'https://res.cloudinary.com/dus2pwnkb/image/upload/v1632351921/Ziwo_nobn04.png',
					tags_id: '10',
					createdAt: new Date(),
					updatedAt: new Date(),
				},
				...
				},
				{
					...
					logo_url:
						'https://res.cloudinary.com/dus2pwnkb/image/upload/v1632351921/groupon_s3fh7y.png',
					tags_id: '2',
					createdAt: new Date(),
					updatedAt: new Date(),
				},
