		...
		return queryInterface.bulkInsert(
			...
			[
				...
				},
				{
					...
					api_id: 2,
					review:
						'This Pixlab REST API works too well. It nonchalantly improves my baseball by a lot.',
					rating: 4,
				},
				{
					user_id: 4,
				...
				},
				{
					...
					api_id: 1,
					review:
						"This Google Analytics Metadata REST API, does exactly what it's suppose to do.",
					rating: 5,
				},
				{
					user_id: 2,
